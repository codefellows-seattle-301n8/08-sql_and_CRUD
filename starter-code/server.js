...
app.get('/articles', function(request, response) {
  // COMMENT: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // Put your response here...
  // Diagram Number: 3! and 4! and then 5(if successful)! or 4(if error)!
...
app.post('/articles', function(request, response) {
  // COMMENT: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // Put your response here...
  // Diagram Number: 3! and then 5 (if successful)! or 4(if error)!
  // Method: Article.prototype.insertRecord =
  // CRUD: create (insert)
  client.query(
    `INSERT INTO
...
app.put('/articles/:id', function(request, response) {
  ...
  // Put your response here...
  // Diagram Number: 3! and then 5 (if successful)! or 4(if error)!
  // Method: Article.prototype.updateRecord =
  // CRUD: update (update)
  client.query(
    `UPDATE articles
    SET
...
app.delete('/articles/:id', function(request, response) {
  ...
  // Put your response here...
  // Diagram Number: 3! and then 5 (if successful)! or 4(if error)!
  // Method: Article.prototype.deleteRecord =
  // CRUD: delete from (delete)
  client.query(
...
// Put your response here...creating table, inserting into table the column titles, calls the loadArticles function which queries the database for articles and if true, do nothing becuase yay! articles. But if false, no articles, then parse ./public/data/hackerIpsum.json for articles to store in database and insete into table.
loadDB();
...
function loadArticles() {
  // COMMENT: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // Put your response here...
  // Diagram Number: 3! and 4! and then 3(if 4 is false)!
  // Method: loadDB(); and then...loadArticles();
  // CRUD: read (select) and if db is empty, create (insert)
